...
const teams = [
  { id: 1, name: "Alamo Web Designs", href: "#", initial: "A", current: false },
];
    ...
    <div>
              ...
              <Dialog.Panel className='relative mr-16 flex w-full max-w-xs flex-1'>
                ...
                <div className='flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4'>
                  <div className='flex h-16 shrink-0 items-center'>
                    <Image className='h-8 w-auto' src={logo} alt='LinkMaster' />
                  </div>
      ...
      <div className='hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col'>
        ...
        <div className='flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4'>
          <div className='flex h-16 shrink-0 items-center'>
            <Image className='mt-10 h-28 w-auto' src={logo} alt='LinkMaster' />
          </div>
              ...
              <Menu as='div' className='relative'>
                <Menu.Button className='-m-1.5 flex items-center p-1.5'>
                  ...
                  <img
                    ...
                    src='https://camthewebguy.com/wp-content/uploads/2022/03/IMG_1799.png'
                    alt=''
                  />
